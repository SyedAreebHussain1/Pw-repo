...
const DashboardEnd = () => {
  ...
  return (
    <>
      <div style={{ marginTop: '2%', border: '' }}>
        <div className="r_e">
          <div className="c_e" style={{ backgroundColor: '' }}>
                  ...
                  >
                    <div className="">
                      ...
                      >
                        ...
                        <div
                          style={{ border: '', width: '100%', padding: '4px' }}
                        >
                          <div>

  ...
  function onFinish(values) {
    if (!newOwnerShow) {
      const body = {
        ...
        loungeOwnerId: values?.loungeOwnerId,
      }
      ...
      const body = {
        ...
        logo: uploadAdvertisement?.data?.data,
        shortDescription: values?.shortDescription,
        loungeOwnerName: values?.loungeOwnerName,
        loungeOwnerEmail: values?.loungeOwnerEmail,
        loungeOwnerPhone: `+${values?.loungeOwnerPhone}`,
      }
      createLoungeApi(dispatch, body, onSuccess)
    }
  }

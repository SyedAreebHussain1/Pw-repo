...
const GeneralListingsTable = () => {
  ...
  // }, [updateListingsApprovals?.data, pageLimit, deleteListingsApproval?.data])

  useEffect(() => {
    scrollToTop()
    debouncedGetAllListingsApprovalsApi(dispatch, pageLimit, search)
  }, [pageLimit, updateListingsApprovals?.data, deleteListingsApproval?.data])
        ...
        <Col lg={24} xs={24}>
          ...
          <Table
            ...
            loading={
              ...
              deleteListingsApproval?.loading
            }
            pagination={{
              total:

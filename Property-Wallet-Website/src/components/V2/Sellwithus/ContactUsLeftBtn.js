...
const ContactUsLeftBtn = ({ setShow, show }) => {
    ...
    const css = {
        ...
        secondDiv: {
            wordWrap: 'break-word', writingMode: 'vertical-rl', textOrientation: 'mixed', transform: 'rotate(180deg)', display: "flex",
        ...
        <>
            <div style={css.headDiv} onClick={handleModal} >
                <div style={css.secondDiv} >
                    ...
                    <div>
                        <p style={{ letterSpacing: '2px', fontWeight: 'bold', color: '#ff8b28', }}>{contactUs}</p>
                    </div>
                </div>
            </div>
        </>

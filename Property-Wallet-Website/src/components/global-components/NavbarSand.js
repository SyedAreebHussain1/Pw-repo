...
import BecomeAPropertyWalletPartnerModal from "./BecomeAPropertyWalletPartnerModal";
const NavbarSand = ({ CustomClass, location }) => {
  ...
  return (
    <>
      <BecomeAPropertyWalletPartnerModal
        show={modalShow}
              ...
              <div className="row">
                ...
                <div className="col header-menu-column">
                  <div className="header-menu d-none d-xl-block go-top">
                    <nav style={{}}>
                      <div className="ltn__main-menu" style={{}}>
                        <ul>
                          <li
                            style={{ fontSize: "18px", marginTop: "" }}
                            className="menu-icon"
                          >
                            <Link to="/">Home</Link>
                          </li>

...
import footerLogo from "../images/footerLogoCrm.png";
...
class Footercrm extends Component {
  componentDidMount() {
    const $ = window.$;
            ...
            <div className="row">
              <div className="col-xl-6 col-md-6 col-sm-6 col-12">
                <div className="footer-widget footer-about-widget">
                  ...
                  <div className="footer-address footer-address1 footer-menu1">
                    <ul>
                      <li>
                        <div className="footer-address-icon">
                          <i className="icon-placeholder" />
                        </div>
                        <div className="footer-address-info pointer">
                          <p
                          // onClick={() => {
                          //     window.open(
                      ...
                      <li>
                        ...
                        <div className="footer-address-info">
                          <p>
                            <a href="tel:03311110379" className="footer-link">
                              0331-111-0379
                            </a>
                          </p>
                        </div>
              ...
              <div className="col-xl-2 col-md-6 col-sm-6 col-12">
                {/* <div className="footer-widget footer-menu-widget clearfix">
                                    ...
                                    <div className="footer-menu footer-menu1 go-top">
                                        <ul>
                                            <li >
                                                <Link to="/inventory-management" className='footer-link' >Inventory Management</Link>
                                            </li>
                                            <li>
                                                <Link to="/staff-management" className='footer-link' >Staff Management</Link>
                                            </li>
                                            <li>
                                                <Link to="/commission-management" className='footer-link' >Commission Management</Link>
                                            </li>
                                            <li>
                                                <Link to="/report-management"className='footer-link'>Report Management</Link>
                                            </li>
                                            <li>
                                                <Link to="/digital-tools"className='footer-link' >Digital Tools</Link>
                                            </li>
                                            <li>
                                                <Link to="/sales-target"className='footer-link' >Target Sales Management</Link>
                                            </li>
                                        </ul>
                                    </div>
                                </div> */}
                ...
                <div className="footer-widget footer-menu-widget clearfix">
                  ...
                  <div className="footer-menu footer-menu1 go-top">
                    <ul>
                      ...
                      <li>
                        <Link to="/how-to-use" className="footer-link">
                          How to use
                        </Link>
                      </li>
                    </ul>

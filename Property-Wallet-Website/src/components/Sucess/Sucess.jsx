  ...
  return (
    <div className="Modal-Sucess">
      ...
      >
        <Result
          status="success"
          title="Your subscription voucher has been successfully purchased"
          subTitle="Redeem your voucher/subscription code in the app to enjoy Property Wallet fully"
        />
        <div gutter={16} style={{ marginLeft: "10%", marginRight: "10%" }}>
          ...
          <Row style={{ marginTop: "2%" }} gutter={16}>
            <Col span={12}>
              <span style={{ color: "grey", fontSize: "16px" }}>Card type</span>
            </Col>
            <Col span={12}>
              <span
                style={{

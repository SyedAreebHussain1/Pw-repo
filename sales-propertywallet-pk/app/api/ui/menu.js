module.exports = [
  {
    key: "dashboard",
    name: "Dashboard",
    icon: require("../icons/0.6.png"),
    linkParent: "/app",
  },
  {
    key: "currentSubscribers",
    name: "Current Subscribers",
    icon: require("../icons/0.3.png"),
    linkParent: "/app/pages/subscriber",
  },
  {
    key: "wallet",
    name: "Wallet",
    icon: require("../icons/walleticon.png"),
    linkParent: "/app/pages/wallet",
  },
  {
    key: "earninghistory",
    name: "Earning History",
    icon: require("../icons/0.4.png"),
    linkParent: "/app/pages/earnings",
  },
  {
    key: "packages",
    name: "Packages",
    icon: require("../icons/refeerals.png"),
    linkParent: "/app/pages/packages",
  },
  {
    key: "support",
    name: "Support",
    icon: require("../icons/supporticon.png"),
    linkParent: "/app/pages/support",
  },
  {
    key: "certificate",
    name: "Certificate",
    icon: require("../icons/supporticon.png"),
    linkParent: "/app/pages/certificate",
  },
  // {
  //   key: "LearningCenter",
  //   name: "Learning Center",
  //   icon: require("../icons/saleordericon.png"),
  //   linkParent: "/app/pages/LearningCenter",
  // },
  // {
  //   key: "no_child",
  //   name: "One Level Menu",
